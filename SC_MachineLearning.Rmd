...
---
### DON'T COPY THIS CODE INTO FINAL .Rmd
...
First, we will need to call all the libraries we will be using and set up the data. 
```{r}
library(fastDummies)
library(dplyr)
library(tidyverse)
...
Now that we have a cleaned dataset, we can get on with fitting our machine learning models.
```{r}
