...
**Data wrangling to create datasets of interest**
    ```{r}
...
t3 <- data_list %>% reduce(left_join, by=c("Country", "Time"))
```
...
ui <- fluidPage(
  ...
  tabsetPanel(
    tabPanel("Labor Force Participation by Sex",
            p("The line plots generated here depict the labor force participation for males and females for OECD countries over time. The data used was created using a number of spreadsheets available from the", a("OECD.", href="https://stats.oecd.org/index.aspx?queryid=54757#")),
    ...
    tabPanel("Female Parliament Seats",
              p("The scatterplots generated here depict the relationship between female labor force participation and female share of seats in national parliament for OECD countries over time. The data used was created using a number of spreadsheets available from the", a("OECD.", href="https://stats.oecd.org/index.aspx?queryid=54757#")),
                 ...
                 # Add some space between the text above and dropdown
                 br(),
             # Dropdown menu that allows the user to choose the countries for the scatterplot
...
server <- function(input, output) {
  ...
  output$Scatterplot1 <- renderPlot({
    t3 %>% 
      ...
      ggtitle(paste("Female Labor Force Participation Rate vs. Female Share of Seats in Natl Parliament in", input$year1)) +
      theme(plot.title = element_text(size = 15, face = "bold"))
  })
  output$Scatterplot2 <- renderPlot({
    t3 %>% 
      ...
      ggtitle(paste("Female Labor Force Participation Rate vs. Female Share of Seats on Boards of Largest Publicly Listed Companies in", input$year2)) +
      theme(plot.title = element_text(size = 15, face = "bold"))
  })
output$Scatterplot3 <- renderPlot({
    t3 %>% 
      ...
      ggtitle(paste("Female Labor Force Participation Rate vs. Female Share of Employed Who are Managers in", input$year3)) +
      theme(plot.title = element_text(size = 15, face = "bold"))
  })
}
)
