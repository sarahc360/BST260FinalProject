...
This plots looks specifically at countries in Europe.The year in which this data was recorded is not determined in the dataset as the recorded year is coded as 'Latest Year'. This is a limitation of the dataset. From the descriptive statistics section, we know that time spent in unpaid work is higher among women than men in all countries in our OECD dataset. For this plot, I created a variable 'unpaid_diff_hours_per_day' to capture that difference in time spent in unpaid work among men and women. 

Plot 1 Interpretation: From the plot, we can see that time spent in unpaid work by women is especially high in Turkey and Portugal and a little less so but still significantly high in Austria, Ireland, Italy, Poland, Lithuana and Latvia. 
...
This plots looks specifically at countries in Europe.The year in which this data was recorded is not determined in the dataset as the recorded year is coded as 'Latest Year'. This is a limitation of the dataset. From the descriptive statistics section, we again know that time spent in paid work is higher among men than women in all countries in our OECD dataset. For this plot, I created a variable 'paid_diff_hours_per_day' to capture that difference in time spent in paid work among men and women. 

Plot 2 Interpretation: From the plot, we can see that time spent in paid work by men is significantly higher in Turkey followed by Portugal, Ireland, Austria, Lithuana and Poland. These results make sense because these were the same countries in which women were spending more time doing unpaid work. We can hence interpret that women might be spending significantly more time in unpaid work in countries where men are spending significantly more time in paid work.

### Plots 3 & 4: Share of female seats in the parliament worldwide (Comparison between years 2006 and 2016)
...
p5 <- managers_map %>%
  ...
  geom_polygon(aes(fill =Share_of_female_managers, group=group), color = "white")+
   scale_fill_gradient("Percentage", limits=c(5,50),low="skyblue", high="dodgerblue4", na.value= 'grey') +
   coord_fixed(1.3) +
...
Plots 6 and 7 Interpretation: This plot shows us data from years 2019 and 2010. We cannot see a significant change in percentage of managerial positions occupied by women between 2010 and 2019. 
...
Plots 8 and 9 Interpretation: These plots look at female share of seats on boards of the largest publicly listed companies in Europe between years 2010 and 2020. Overall, it looks like the percentage of seats increased for most of the countries with the exception of Turkey, Greece, Lithuana and Estonia. This data again supports the information from previous plots where we saw that the difference in time spent in paid work between men and women were significantly higher in Turkey (also quite high in Lithuana). Through this we can interpret that the share of females in boards of the largest publicly listed companies among countries might be lower in countries where men spend more time in paid work than women/ where women spend more time in unpaid work than men. 
