...
While the linear regression did not find any statistically significant predictors for proportion of time spent in unpaid work among females, the regression tree uses other covariates, including sex, to predict the unpaid work proportion from the observations available. The model is limited by small sample size and potential discrepancies in "latest year" reported by each country, but provides directional insight on variables that can predict the outcome of interest.
